...
default_results = {
    ...
    "v1_4_3": {
        ...
        "sample_biiou": 0.5039622042094377,
        "sample_bikappa": 0.6510635726572914,
        "sample_bimsiou": 0.8227620408962383,
        "sample_bioa": 0.964811758770181,
        "sample_bipre": 0.5916996553523113,
        "sample_birec": 0.5592859147614985,
        "sample_bifpr": 0.02004309090816628,
...
class CheckMetricTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.default_results = default_results["v1_4_3"]
    ...
    def test_msiou(self):
        ...
        self.assertEqual(
            self.curr_results["sample_bimsiou"], self.default_results["sample_bimsiou"]
        )
    ...
    def test_dice(self):
        ...
        self.assertEqual(
            self.curr_results["overall_bidice"], self.default_results["overall_bidice"]
        )
    ...
    def test_spec(self):
        ...
        self.assertEqual(
            self.curr_results["overall_bispec"], self.default_results["overall_bispec"]
        )
    ...
    def test_kappa(self):
        ...
        self.assertEqual(
            self.curr_results["sample_bikappa"], self.default_results["sample_bikappa"]
        )
        self.assertEqual(
            self.curr_results["overall_bikappa"], self.default_results["overall_bikappa"]
        )
