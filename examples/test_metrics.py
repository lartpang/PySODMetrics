...
FMv2 = py_sod_metrics.FmeasureV2(
    metric_handlers=[
        py_sod_metrics.FmeasureHandler(with_adaptive=True, with_dynamic=True, with_binary=True),
        py_sod_metrics.PrecisionHandler(with_adaptive=True, with_dynamic=True, with_binary=True),
        py_sod_metrics.RecallHandler(with_adaptive=True, with_dynamic=True, with_binary=True),
        py_sod_metrics.SpecificityHandler(with_adaptive=True, with_dynamic=True, with_binary=True),
        py_sod_metrics.IOUHandler(with_adaptive=True, with_dynamic=True, with_binary=True),
        py_sod_metrics.DICEHandler(with_adaptive=True, with_dynamic=True, with_binary=True),
        py_sod_metrics.BERHandler(with_adaptive=True, with_dynamic=True, with_binary=True),
    ]
)
...
default_results = {
    ...
    "v1_4_0": {
        ...
        "biberv2": 0.2303662750520886,
        "bidicev2": 0.5738178377545774,
        "bifm2": 0.5829376208352652,
        "biiouv2": 0.5039325077397586,
        "biprev2": 0.5916023995572804,
        "birecv2": 0.559349474925166,
        "bispecv2": 0.9799179749706569,
        "maxEm": 0.9669544828922699,
        "maxFm": 0.5886784581120638,
